...
public class ActiveMqTest {
    ...
    public void testQueueProducer() throws Exception {
        ...
        ConnectionFactory connectionFactory = new ActiveMQConnectionFactory("tcp://192.168.84.128:61616");
        ...
        TextMessage textMessage = session.createTextMessage("message queue2");
        //8.发送消息
